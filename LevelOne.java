...
public class LevelOne extends Levels
{
    ...
    private void prepareEntities() {
        addObject(new Zombie(100.0, 1), 90, 180);
        addObject(new Zombie(100.0, 1), 60, 180);
        addObject(new Zombie(100.0, 1), 90, 70);
    ...
    private void prepareObjects() {
        addObject(new Copper(), 94, 28);
        addObject(new Copper(), 94, 28);
        addObject(new Iron(), 28, 28);
        addObject(new Copper(), 60 , 28);
        addObject(new Silver(), 28, 186);
        addObject(new Silver(), 28, 186);
        addObject(new Iron(), 28, 186);
        addObject(new Silver(), 28, 106);
